...
## Hardware.
The hardware consists of an Arduino Uno with  TB6612 based dual motor control module and two 6 volt DC motors. The following files are used for this project:
...
3.  After uploading the compiled firmware the the Uno, the pin 13 LED should flash twice and then the motors should move as follows:
